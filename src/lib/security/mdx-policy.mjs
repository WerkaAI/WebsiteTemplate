...
const mdxSanitizeSchema = {
  ...
  attributes: {
    ...
    div: mergeAttributeList(baseAttributes.div ?? [], ["className", "data-mdx-placeholder"]),
    span: mergeAttributeList(baseAttributes.span ?? [], ["className", "style"]),
    code: mergeAttributeList(baseAttributes.code ?? [], ["className", "style"]),
    pre: mergeAttributeList(baseAttributes.pre ?? [], ["className", "style"]),
    ...
    div: mergeAttributeList(baseAttributes.div ?? [], ["className", "data-mdx-placeholder", "data-mdx-attributes"]),
    InteractiveChecklist: mergeAttributeList(baseAttributes.div ?? [], ["items", "id"]),
    ProgressBar: mergeAttributeList(baseAttributes.div ?? [], []),
    FAQAccordion: mergeAttributeList(baseAttributes.div ?? [], ["items"]),
    Tip: mergeAttributeList(baseAttributes.div ?? [], ["type", "title"]),
    Callout: mergeAttributeList(baseAttributes.div ?? [], ["type", "title"]),
    VideoPlayer: mergeAttributeList(baseAttributes.div ?? [], ["src", "title", "poster"]),
    TutorialStep: mergeAttributeList(baseAttributes.div ?? [], ["stepNumber", "title"]),
  },
};
