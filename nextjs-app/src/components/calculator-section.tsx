    ...
    <section className="section-padding bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-xl text-muted-foreground" data-testid="text-calculator-subtitle">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <div className="text-sm text-green-700 mb-1">Odzyskany czas miesięcznie</div>
                    <div className="text-2xl font-bold text-green-800" data-testid="stat-time-saved">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="text-sm text-blue-700 mb-1">Wolne weekendy rocznie</div>
                    <div className="text-2xl font-bold text-blue-800" data-testid="stat-weekends-saved">
                  ...
                  <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                    <div className="text-sm text-primary mb-1">Inwestycja w AutoŻabę</div>
                    <div className="text-2xl font-bold text-primary" data-testid="stat-autozaba-cost">
                  ...
                  {calculations.monthlyBenefit > 0 && (
                    <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-4">
                      <div className="text-sm text-green-700 mb-1 font-semibold">Spokój ducha</div>
                      <div className="text-lg font-bold text-green-800" data-testid="stat-peace-of-mind">
                        Bezcenny
                      </div>
                      <div className="text-xs text-green-600">
